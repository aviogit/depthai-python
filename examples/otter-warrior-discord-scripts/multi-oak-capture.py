...
# script found on Discord, by otter_warrior
# https://discord.com/channels/790680891252932659/799790138753286215/837655704256774175
...
videoEncoder.setDefaultProfilePreset(rgb_w_px, rgb_h_px, fps, dai.VideoEncoderProperties.Profile.H265_MAIN)
        ...
        while t_record_curr<t_record_max:
            ...
            for i, qRgb in enumerate(qRgb_list):
                ...
                if h265Packet is not None:
                    ...
                    h265Packet.getData().tofile(videoFile_list[i])
                    ...
                    csvWriter_list[i].writerow([num_frames[i], seq_num, ts_monotonic, ts_time])
